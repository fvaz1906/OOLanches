...
public partial class HomePage : ContentPage
{
    ...
    private Task<IEnumerable<Categoria>> GetListaCategorias()
    {
        return GetListaCategorias(CvCategorias);
    }

    private async Task<IEnumerable<Categoria>> GetListaCategorias(CollectionView cvCategorias)
    {
        try
        {
